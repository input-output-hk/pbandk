...
sealed interface TestAllTypesProto3 : pbandk.Message {
    ...
    sealed interface MapStringNestedMessageEntry : pbandk.Message, Map.Entry<String, pbandk.testpb.TestAllTypesProto3.NestedMessage?> {
        override val key: String
    ...
    sealed interface MapStringForeignMessageEntry : pbandk.Message, Map.Entry<String, pbandk.testpb.ForeignMessage?> {
        override val key: String
    ...
    sealed interface MapStringNestedEnumEntry : pbandk.Message, Map.Entry<String, pbandk.testpb.TestAllTypesProto3.NestedEnum> {
        override val key: String
    ...
    sealed interface MapStringForeignEnumEntry : pbandk.Message, Map.Entry<String, pbandk.testpb.ForeignEnum> {
        override val key: String
